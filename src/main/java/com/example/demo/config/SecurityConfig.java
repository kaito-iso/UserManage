...
import com.example.demo.constant.RoleConst;
	...
	SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		...
		http
				...
				.authorizeHttpRequests(authz -> authz
						...
						// ADMINユーザーのみのアクセス権限
						.requestMatchers("/users-view/**").hasRole(RoleConst.ADMIN)
						.requestMatchers("/sign-up").hasRole(RoleConst.ADMIN)
						.requestMatchers("/administrator/**").hasRole(RoleConst.ADMIN)
